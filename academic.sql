...
CREATE TABLE `researcher` (
  ...
  `field_of_research` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `article_ids` text,
  `patent_ids` text,
  `project_ids` text,
  `award_ids` text,
...
CREATE TABLE `article` (
  ...
  `field_of_research` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '所属领域',
  `publish_time` datetime DEFAULT NULL COMMENT '发表时间',
  `category_num` varchar(256) DEFAULT NULL COMMENT '分类号',
